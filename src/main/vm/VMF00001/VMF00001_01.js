...
import { BillDocMasterForm } from "./VMF00001_02";
...
const BillDocMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/VMF00001/openForm', openForm_post_obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "iBillDocNm",
                header: "Bill Document Description",
                size: 240,
        ...
        <>
            ...
            <div>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Bill Document Master</h1>
                        ...
                        <div className="container-fluid mb-5">
                            <form onSubmit={postQuery} id="myForm" className="py-4">
                                <div className="row mb-2 mx-2 ">
                                    ...
                                    >
                                        <b>Bill Document Description: <span className="text-red">*</span></b>
                                        {/* <span className="text-red">*</span> */}
                                    </label>
                                    <div className="col-sm-4 mb-2">
                                        <input value={queryInputObj?.criteria?.iBillDocNm} name="iBillDocNm" required onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="" />
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsgTyp, parMsg, setParMsg, setParMsgTyp, parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/VMF00001/openAddForm"
            body = {
                apiId: 'VMA00003',
            }
