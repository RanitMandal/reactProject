...
import { CaseTypeDefinitionForm } from "./CIF00002_02";
...
const CaseTypeDefinition = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00002/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "ccaseTypNmSh",
                header: "Name",
                size: 240,

            },
            {
                accessorKey: "ccaseTypNmFull",
                header: " Full Name",
                size: 240,
    ...
    const handle_savePath = async()=>{
        ...
        const body = {
            ...
            "ccaseTypNmFull": currentPath?.ccaseTypNmFull,
      "ccaseTypNmSh": currentPath?.ccaseTypNmSh
            }
          }
        
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00002/saveAdd', 
        body, 
        { headers }
        ).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title"> Case Type Definition</h1>
          ...
          <i className="fa fa-star"></i> */}
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/CIF00002_03`}
                        >
                            <span>
                    ...
                    <div className="container-fluid mb-5">
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                >
                                    <b>Court Case Type Name:</b>
                                    {/* <span className="text-red">*</span> */}
                                </label>
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.ccaseTypNmSh} name="ccaseTypNmSh" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Court Case Type Name" />
...
export default CaseTypeDefinition;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/CIF00002/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00002/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00002/openEditForm";
            body = {
                apiId: "CIA00032",
                mst: {
                    ccaseTypCd: rowData.ccaseTypCd
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00002/openDeleteForm";
            body = {
                apiId: "CIA00031",
                mst: {
                    ccaseTypCd: rowData.ccaseTypCd
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00002/openViewForm";
            body = {
                apiId: "CIA00034",
                mst: {
                    ccaseTypCd: rowData.ccaseTypCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <CaseTypeDefinitionForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
