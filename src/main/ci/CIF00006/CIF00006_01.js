...
import { OtherAdvocateDefinitionForm } from "./CIF00006_02";
...
const OtherAdvocateDefinition = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00006/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            {
                accessorKey: "othAdvocateCd",
                header: " Other Advocate Code",
            ...
            {
                accessorKey: "othAdvocateNm",
                header: "Other Advocate Name",
                size: 240,

            },

            {
                accessorKey: "othMobNo",
                header: "Other Mobile No",
                size: 240,

            },

            {
                accessorKey: "othEmailId",
                header: "Other Email Id",
                size: 240,
    ...
    const handle_savePath = async()=>{
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00006/saveAdd', 
        body, 
        { headers }
        ).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title"> Other Advocate Definition</h1>
          ...
          <i className="fa fa-star"></i> */}
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        {/* <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/CIF00006_03`}
                        >
                            <span>
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.othAdvocateNm} name="othAdvocateNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder=" Other Advocate" />
...
export default OtherAdvocateDefinition;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/CIF00006/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00006/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00006/openEditForm";
            body = {
                apiId: "CIA00023",
                mst: {
                   othAdvocateCd: rowData.othAdvocateCd
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00006/openDeleteForm";
            body = {
                apiId: "CIA00022",
                mst: {
                   othAdvocateCd: rowData.othAdvocateCd
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00006/openViewForm";
            body = {
                apiId: "CIA00025",
                mst: {
                   othAdvocateCd: rowData.othAdvocateCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <OtherAdvocateDefinitionForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
