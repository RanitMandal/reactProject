...
import { AdvocateDefinitionForm } from "./CIF00003_02";
...
const AdvocateDefinition = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00003/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            {
                accessorKey: "advocateCd",
                header: "Advocate Code",
    ...
    const handle_savePath = async()=>{
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00003/saveAdd', 
        body, 
        { headers }
        ).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Advocate Definition</h1>
          ...
          <i className="fa fa-star"></i> */}
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        {/* <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/CIF00003_03`}
                        >
                            <span>
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.advocateNm} name="advocateNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Advocate" />
...
export default AdvocateDefinition;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/CIF00003/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00003/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00003/openEditForm";
            body = {
                apiId: "CIA00014",
                mst: {
                   advocateCd: rowData.advocateCd
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00003/openDeleteForm";
            body = {
                apiId: "CIA00013",
                mst: {
                   advocateCd: rowData.advocateCd
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00003/openViewForm";
            body = {
                apiId: "CIA00016",
                mst: {
                   advocateCd: rowData.advocateCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <AdvocateDefinitionForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
