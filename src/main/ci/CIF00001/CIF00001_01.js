...
import { CourtDefinitionForm } from "./CIF00001_02";
...
const CourtDefinition = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/CIF00001/openForm', obj, { headers }).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title"> Court Definition</h1>
          ...
          <i className="fa fa-star"></i> */}
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/CIF00001_03`}
                        >
                            <span>
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.courtNm} name="courtNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Court Name" />
...
export default CourtDefinition;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp, parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/CIF00001/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00001/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00001/openEditForm";
            body = {
                apiId: "CIA00005",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00001/openDeleteForm";
            body = {
                apiId: "CIA00004",
                mst: {
                    courtId: rowData.courtId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/CIF00001/openViewForm";
            body = {
                apiId: "CIA00007",
                mst: {
                    courtId: rowData.courtId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <CourtDefinitionForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
