...
import { ExternalUserTypeMasterForm } from "./SUF00149_02";
...
const ExternalUserTypeMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00149/openForm', obj, { headers }).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">External User Type Master</h1>
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/SUF00149_03`}
                        >
                            <span>
                    ...
                    <div className="container-fluid mb-5">
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                >
                                    <b>External User Type Description:</b>
                                    {/* <span className="text-red">*</span> */}
                                </label>
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.extUserTypDesc} name="extUserTypDesc" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="External User Type Description" />
...
export default ExternalUserTypeMaster;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00149/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00149/openEditForm";
            body = {
                apiId: "SUA00624",
                mst: {
                    extUserTypCd: rowData.extUserTypCd
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00149/openDeleteForm";
            body = {
                apiId: "SUA00626",
                mst: {
                    extUserTypCd: rowData.extUserTypCd
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00149/openViewForm";
            body = {
                apiId: "SUA00623",
                mst: {
                    extUserTypCd: rowData.extUserTypCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <ExternalUserTypeMasterForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
