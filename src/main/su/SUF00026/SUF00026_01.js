...
import { SecretQuestionSettingForm } from "./SUF00026_02";
...
const SecretQuestionSetting = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00026/openForm', obj, { headers }).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Secret Question Setting</h1>
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/SUF00026_03`}
                        >
                            <span>
                    ...
                    <div className="container-fluid mb-5">
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                >
                                    <b>Secret Question Setting:</b>
                                    {/* <span className="text-red">*</span> */}
                                </label>
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.qustDesc} name="qustDesc" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Secret Question Setting Name" />
...
export default SecretQuestionSetting;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp , parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00026/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00026/openEditForm";
            body = {
                apiId: "SUA00427",
                mst: {
                    qustId: rowData.qustId
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00026/openDeleteForm";
            body = {
                apiId: "SUA00429",
                mst: {
                    qustId: rowData.qustId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00026/openViewForm";
            body = {
                apiId: "SUA00426",
                mst: {
                    qustId: rowData.qustId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <SecretQuestionSettingForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
                    msg={msg} setMsg={setMsg} msgTyp={msgTyp} setMsgTyp={setMsgTyp} addVal={addVal} setEdtVal={setEdtVal} edtVal={edtVal} parMsg={parMsg}
                setParMsg={setParMsg}
                parMsgTyp={parMsgTyp}
                setParMsgTyp={setParMsgTyp} errExp={errExp} set_errExp={set_errExp} parErrExp={parErrExp} set_parErrExp={set_parErrExp}/>
            </DialogContent>
