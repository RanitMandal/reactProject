...
import { LocationTypeForm } from "./SUF00004_02";
...
const LocationType = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async ()=>{
          let obj={
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX +'/SUF00004/openForm',obj, {headers} ).then((res)=>{
    ...
    return (
        ...
        <div>
          <h1 className="page-title">Location Type </h1>
      ...
      to={`${process.env.PUBLIC_URL}/SUF00004_03`}
    >
      <span>
          ...
          <div className="container-fluid mb-5">
                    <form onSubmit={postQuery} id="myForm" className="py-4" >
                        <div className="row mb-2 mx-2 ">
                            ...
                            >
                                <b>Location Type Name:</b>
                                {/* <span className="text-red">*</span> */}
                            </label>
                            <div className="col-sm-4 mb-2">
                                <input value={queryInputObj.criteria.lvlTypNm} name="lvlTypNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Location Type Name"  />
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsgTyp, parMsg, setParMsg, setParMsgTyp,  parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if(mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00004/openAddForm"
        }
        if(mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00004/openEditForm";
            body={
                apiId: "SUA00096",
                mst: {
                  lvlTypCd: rowData.lvlTypCd
                }
              }
        }
        if(mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00004/openDeleteForm";
            body={
                apiId: "SUA00100",
                mst: {
                  lvlTypCd: rowData.lvlTypCd
        ...
        if(mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00004/openViewForm";
            body={
                apiId: "SUA00094",
                mst: {
                  lvlTypCd: rowData.lvlTypCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            {/* {msg&&<span>{msg}</span>} */}
                <LocationTypeForm  mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj} 
                msg={msg} setMsg={setMsg} msgTyp={msgTyp} setMsgTyp={setMsgTyp} edtVal = {edtVal} setEdtVal={setEdtVal} addVal={addVal} setParMsg={setParMsg}
