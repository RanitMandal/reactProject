...
import { HelpFrom } from "./SUF00155_02";
...
const Help = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00155/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                header: "Display Order No",
                size: 240

            },
            {
                accessorKey: "pubDispFlgTxt",
                header: "Pub Display Flag",
                size: 240
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Technical Help Desk</h1>
                    ...
                    <div className="container-fluid mb-5">
                        ...
                        <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.contactNm} name="contactNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Contact Name" />
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp, parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00155/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00155/openEditForm";
            body = {
                apiId: "SUA00554",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00155/openDeleteForm";
            body = {
                apiId: "SUA00553",
                mst: {
                    contactId: rowData.contactId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00155/openViewForm";
            body = {
                apiId: "SUA00556",
                mst: {
                    contactId: rowData.contactId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <HelpFrom mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
