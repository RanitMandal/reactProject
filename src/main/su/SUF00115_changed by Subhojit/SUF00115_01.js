    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            {/* {msg&&<span>{msg}</span>} */}
                ...
                msg={msg} setMsg={setMsg} msgTyp={msgTyp} setMsgTyp={setMsgTyp} editFormData={editFormData} setEditFormData={setEditFormData} 
                defaultData={defaultData} setDefaultData={setDefaultData} openPageData={openPageData} setopenPageData={setOpenPageData} errExp={errExp} set_errExp={set_errExp}/>
            </DialogContent>
