...
const UserTypDescMulForm = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00148/openAddForm', obj, { headers }).then((res) => {
    ...
    const addtableRow = () => {
        const hasBlankFields = tableRow.some((row) => !row.userTypDesc || !row.actFlg);
        ...
        if (hasBlankFields) {
            ...
            const updatedRows = tableRow.map((row) => ({
                ...row,
                errors: {
                    userTypDesc: !row.userTypDesc ? "Please fill in this field." : '',
    ...
    const finalSubmit = async (e) => {
        ...
        let body = {
            ...
            mst: tableRow.map((row) => ({
                actFlg: row.actFlg,
                userTypDesc: row.userTypDesc,
            })),
        }

        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00148/saveAdd', body, { headers }).then((res) => {
    ...
    return (
        <div openData={openData}>
            <div className="page-header">
                <div>
                    <h1 className="page-title">User Type Description - Multiple Add</h1>
                ...
                <div className="ms-auto pageheader-btn">
                    ...
                    <Link
                        ...
                        to={`${process.env.PUBLIC_URL}/SUF00148_01`}
                    >
                        <span>
                                            ...
                                            <table className="table  dta-tabl" style={{ background: 'white' }}>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {/* <th> Id</th> */}
                                                        <th> User Type Desc<span className="text-red">*</span></th>
                                            ...
                                            {row.error && <div className="error-message">{row.error}</div>}
                                                            ...
                                                            <td>
                                                                <div className="col-md-12 input-group">
                                                                    ...
                                                                    />
                                                                    {charCount[index].isTyping && <span className="input-group-text">{row.userTypDesc.length}/50</span>}
                                                                ...
                                                                {row.errors.userTypDesc && (
                                                                    <div className="error-message text-red text-center">{row.errors.userTypDesc}</div>
                                                                )}
                                                            </td>
                                                            <td>
                                                                <select
...
export default UserTypDescMulForm;