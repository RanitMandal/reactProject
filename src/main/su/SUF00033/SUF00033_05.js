...
export default function Profile() {
    const regNm = getScplAdContext().regNm;
    const sysRegNo = getScplAdContext().sysRegNo;
    const mobNo = getScplAdContext().mobNo;
    const mailId = getScplAdContext().mailId;
              ...
              <div className="wideget-user">
                <Row>
                  <Col lg={12} md={12} xl={6}>
                    <div className="wideget-user-desc d-sm-flex">
                      {/* <div className="wideget-user-img">
                        <img className="" src={user8} alt="logo" />
                      </div> */}
                      <div className="media-icon bg-success me-3 mt-1">
                        <i className="fe fe-user  fs-40 text-white"></i>
                      </div>
                      <div className="user-wrap">
                        <h4>{regNm}</h4>
                        {/* <h6 className="text-muted mb-3">
                          Software Agency [ Member Since: November 2007]
                        </h6> */}
                  ...
                  <Col lg={12} md={12} xl={6}>
                      ...
                      <Link
                        to=
                        {`${process.env.PUBLIC_URL}/pages/editProfile/`} 
                        {`${process.env.PUBLIC_URL}/NewApplication`}
                                ...
                                <div className="table-responsive p-1">
                                  <Table className="table row table-borderless">
                                    ...
                                    <tbody className="col-lg-12 col-xl-6 p-0">
                                      {/* <tr>
                                        <td>
                                          <strong>Address :</strong> {data.officeAddress}
                                        </td>
                                      </tr> */}
                                      <tr>
                                        <td>
                                          <strong>Reistered Email ID :</strong>
                                          &nbsp;&nbsp;{mailId}
                                        </td>
                                      </tr>
                                      <tr>
