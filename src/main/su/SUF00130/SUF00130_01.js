...
const OtpTypMasters = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00130/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            {
                accessorKey: "otpTypCd",
                header: "OTP Type Code",
            ...
            {
                accessorKey: "otpTypDesc",
                header: "OTP Type Description",
                size: 240,

            },
            {
                accessorKey: "otpMobFlgTxt",
                header: "OTP Mobile Flag ",
                size: 240

            },
            {
                accessorKey: "otpEmailFlgTxt",
                header: "OTP Email Flag",
                size: 240

            },
            {
                accessorKey: "userOptnSelFlgTxt",
                header: "User Option Selection Flag",
                size: 240
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">OTP Type Master</h1>
