...
import { StateMasterForm } from "./SUF00025_02";
...
const StateMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async ()=>{
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX +'/SUF00025/openForm',obj, {headers} ).then((res)=>{
...
console.log(msg);
    ...
    return (
        ...
        <div>
          <h1 className="page-title">State Master</h1>
      ...
      to={`${process.env.PUBLIC_URL}/SUF00025_03`}
    >
      <span>
        ...
        <div className="card">
          <div className="container-fluid mb-5">
                    ...
                    <form onSubmit={postQuery} id="myForm" className="py-4">
                        <div className="row mb-2 mx-2 ">
                            ...
                            <div className="col-sm-4 mb-2">
                                <input value={queryInputObj.stateNm} name="stateNm" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="State Name"  />
            ...
            <CreateModal
                ...
                setParMsg={setMsg}
                parMsgTyp={msgTyp}
                setParMsgTyp={setMsgTyp}parErrExp={errExp}
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp, parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if(mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00025/openAddForm"
        }
        if(mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00025/openEditForm";
            body={
                apiId: "SUA00201",
                mst:{
                
                        stateCd: rowData.stateCd 
        ...
        if(mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00025/openDeleteForm";
            body={
                apiId: "SUA00200",
                mst:{
        ...
        if(mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00025/openViewForm";
            body={
                apiId: "SUA00203",
                mst:{
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            {/* {msg&&<span>{msg}</span>} */}
                <StateMasterForm  mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj} 
                msg={msg} setMsg={setMsg} msgTyp={msgTyp} setMsgTyp={setMsgTyp} edtVal={edtVal} setEdtVal={setEdtVal} addVal={addVal}  parMsg={parMsg}
                setParMsg={setParMsg} parMsgTyp={parMsgTyp} setParMsgTyp={setParMsgTyp} errExp={errExp} set_errExp={set_errExp} parErrExp={parErrExp} set_parErrExp={set_parErrExp}/>
            </DialogContent>
