...
const TempForm = () => {
    ...
    const fetchOpenData = async () => {
      try {
        const response = await axios.post(
          process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/openForm",
          openFormObj,
          { headers }
        );
  ...
  useEffect(() => {
    ...
    const fetchModuleGrpLovData = async () => {
      await axios
        .post(process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/getAllModGrp", modGrpLovObj, {
          headers,
        })
        .then((res) => {
    ...
    <>
      <div>
        <div className="page-header">
          <div>
            <h1 className="page-title">Temporary Form by Copying Template</h1>
...
export const CreateNewAccountModal = ({
  ...
  useEffect(() => {
    ...
    if (mode === 1) {
      url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/openAddForm";
      body = {
        apiId: "SUA00398",
      };
    ...
    if (mode === 2) {
      url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/openEditForm";
      body = {
        apiId: "SUA00401",
        mst: {
          tmpFormId: rowData.tmpFormId,
    ...
    if (mode === 3) {
      url =
        process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/openDeleteForm";
      body = {
        apiId: "SUA00403",
        mst: {
          tmpFormId: rowData.tmpFormId,
    ...
    if (mode === 4) {
      url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00127/openViewForm";
      body = {
        apiId: "SUA00400",
        mst: {
          tmpFormId: rowData.tmpFormId,
