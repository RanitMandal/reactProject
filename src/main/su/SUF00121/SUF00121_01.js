...
import { AppMstForm } from "./SUF00121_02";
...
//   };
  ...
  useEffect(() => {
    const fetchOpenData = async () => {
      ...
      await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00121/openForm', obj, { headers }).then((res) => {
    ...
    <>
      ...
      <div>
        <div className="page-header">
          <div>
            <h1 className="page-title">App Master</h1>
          ...
          <div className="container-fluid mb-5">
            <form onSubmit={postQuery} id="myForm" className="py-4">
              ...
              <div className="row mb-2">
                <label className="col-md-3 col-form-label"><b>App Category:</b></label>
                <div className="col-md-6">
                  <div className="input-group">
                    <span class="input-group-text bg-primary" ><i className="fa fa-search d-inline text-white" title="" onClick={() => setShowModelAppCatLov(true)} /></span>
                    ...
                    <input
                      ...
                      value={getAppCatId(selectRowAppCatLov) ? getAppCatId(selectRowAppCatLov) : ''}
                    />
                    <input
                      type="text"
                      autoComplete={false}
                      ...
                      value={getAppCatNm(selectRowAppCatLov) ? getAppCatNm(selectRowAppCatLov) : ''}
                    />
              ...
              <div class="row mb-2 me-1 ">
                ...
                <label className="col-md-3 d-flex justify-content-md-cente form-label">API Description:</label>
                <div className="col-md-6">
                <input value={queryInputObj.criteria.appDesc} name="appDesc" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder=""  />
</div>
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp  }) => {
  ...
  useEffect(() => {
      ...
      if (mode === 1) {
          url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00121/openAddForm";
      }
      if (mode === 2) {
          url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00121/openEditForm";
          body = {
            apiId: "SUA00336",
            mst: {
              // appCatCd: queryInputObj.criteria.appCatCd,
              appId: rowData.appId
            }
          }
      }
      if (mode === 3) {
          url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00121/openDeleteForm";
          body = {
            apiId: "SUA00334",
            mst: {
              // appCatCd: queryInputObj.criteria.appCatCd,
      ...
      if (mode === 4) {
          url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00121/openViewForm";
          body = {
            apiId: "SUA00338",
            mst: {
              // appCatCd: queryInputObj.criteria.appCatCd,
  ...
  return (
      ...
      <Dialog open={open} setData={setData} data={data} fullWidth
          ...
          <DialogContent className="pb-0" >
              ...
              <AppMstForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
