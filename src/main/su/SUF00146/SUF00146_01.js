...
import { ChangeRequestTypeMasterForm } from "./SUF00146_02";
...
const ChangeRequestTypeMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00146/openForm', obj, { headers }).then((res) => {
    ...
    const postQuery = async (e) => {
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/SUF00146/getListPageData', queryInputObj, { headers }).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Change Request Type Master</h1>
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/SUF00146_03`}
                        >
                            <span>
                    ...
                    <div className="container-fluid mb-5">
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                >
                                    <b>Change Request Type Master:</b>
                                    {/* <span className="text-red">*</span> */}
                                </label>
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria?.chgReqTypDesc} name="chgReqTypDesc" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Change Request Type Master" />
...
export default ChangeRequestTypeMaster;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00146/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00146/openEditForm";
            body = {
                apiId: "SUA00588",
                mst: {
                    chngReqTypCd: rowData?.chngReqTypCd
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00146/openDeleteForm";
            body = {
                apiId: "SUA00590",
                mst: {
                    chngReqTypCd: rowData?.chngReqTypCd
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/SUF00146/openViewForm";
            body = {
                apiId: "SUA00587",
                mst: {
                    chngReqTypCd: rowData?.chngReqTypCd
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <ChangeRequestTypeMasterForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
