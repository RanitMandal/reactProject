...
export const ChangeReqstForm = ({ editMode, post, dispatch, mode, rowId, setData, data, onClose, row, rowData, edtVal, setEdtVal, updateEdtVal, index, queryInputObj, setQueryInputObj, msg, setMsg, msgTyp, setMsgTyp, addVal, errExp, set_errExp, }) => {
  ...
  useEffect(() => {
    if (mode !== 1) {
      ...
      setFormData({
        ...
        appId: edtVal?.appId !==null ? edtVal.appId : "",
        ...
        formId: edtVal?.formId !==null ? edtVal.formId : "",
        formNm: edtVal ? edtVal.formNm : "",
        fromLvlRefCd: rowData ? rowData.fromLvlRefCd : "",
        modId: edtVal?.modId !==null ? edtVal.modId : "",
        modNm: edtVal ? edtVal.modNm : "",
        reqAppLogNo: rowData ? rowData.reqAppLogNo : "",
        status: edtVal?.status ? edtVal?.status : "1",
        userId: rowData ? rowData.userId : userId,
        reqEmailId: rowData ? rowData?.reqEmailId: reqEmailId,
        reqMobNo: rowData ? rowData?.reqMobNo:reqMobNo
      })
    ...
    <div className="container">
      ...
      <form className="form-horizontal container" id="EditPageForm" onSubmit={(e) => handleSubmit(e, mode, data, setData, onClose)}>
        ...
        <div className="row mb-4 ">
          ...
          <div className="col-md-9">
            <div className="input-group">
              {(mode === 1 || mode === 2) && <span class="input-group-text bg-primary" ><i className="fa fa-search d-inline text-white" title="" onClick={() => setShowModelChngReqLov(true)} /></span>}
        ...
        <div className="row mb-4 ">
          ...
          <div className="col-md-9">
            <div className="input-group">
              {(mode === 1 || mode === 2) && <span class="input-group-text bg-primary" ><i className="fa fa-search d-inline text-white" title="" onClick={() => setShowModelFormLov(true)} /></span>}
        ...
        {((mode !== 1) && (formData.status==="1")) && <> <div className="row mb-4 ">
          ...
          <div className="col-md-9">
            <div className="input-group">
              {(mode === 1 || mode === 2) && <span class="input-group-text bg-primary" ><i className="fa fa-search d-inline text-white" title="" onClick={() => setShowModelContactLov(true)} /></span>}
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-9">
              <input type="text" className="form-control" name="respSlNo" value={formData.respSlNo} />
            </div>
          </div></>}
