...
const ChngRqstTracking = ({ rowData, edtVal, msg, setMsg, msgTyp, setMsgTyp, errExp, set_errExp, }) => {
    ...
    useEffect(() => {
        ...
        handleViewDtl(view_obj).then((res) => {
            console.log(res);
...
export default ChngRqstTracking;
