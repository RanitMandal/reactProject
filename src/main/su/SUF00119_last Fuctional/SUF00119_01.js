...
import  ApiMasterForm  from "./SUF00119_02";
...
const ApiMasterTemp = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async ()=>{
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX +'/SUF00119/openForm', openFormObj, {headers} ).then((res)=>{
...
//Form Lov Ends
    ...
    return (
        ...
        <div>
          <h1 className="page-title">API Master Temporary</h1>
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj  }) => {
    ...
    useEffect(() => {
        ...
        if(mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00119/openAddForm";
            body={
                apiId : "SUA00385"   
            }
        }
        if(mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00119/openEditForm";
            body={
                apiId : "SUA00387",
                mst: 
                    {
        ...
        if(mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00119/openDeleteForm";
            body={
                apiId : "SUA00386",
                mst: 
                    {
        ...
        if(mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX +"/SUF00119/openViewForm";
            body={
                apiId : "SUA00390",
                mst: 
                    {
