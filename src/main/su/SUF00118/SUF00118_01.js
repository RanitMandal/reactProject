...
const ApiBatchProcess = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async ()=>{
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX +'/SUF00118/openForm', openFormObj, {headers} ).then((res)=>{
 ...
 //Module Lov Starts     
      ...
      useEffect(() => {
        ...
        const fetchModuleLovData = async () => {
          await axios
            .post(process.env.REACT_APP_API_URL_PREFIX +"/SUF00118/getAllModMst", modLovObj, {headers} )
            .then((res) => {
              console.log(res.data);
...
useEffect(() => {
  ...
  const fetchApiCatLovData = async () => {
    await axios
      .post(process.env.REACT_APP_API_URL_PREFIX +"/SUF00118/getAllCatMst", apiCatLovObj, {headers} )
      .then((res) => {
        console.log(res.data);
...
useEffect(() => {
  ...
  const fetchApiLovData = async () => {
    await axios
      .post(process.env.REACT_APP_API_URL_PREFIX +"/SUF00118/getApiByFormMstAndModMst", apiLovObj, {headers} )
      .then((res) => {
        console.log(res.data);
...
//Api Lov Ends
    ...
    const postQuery = async (e)=>{
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX +'/SUF00118/getListPageData',queryInputObj, {headers}).then((res)=>{
    ...
    return (
        ...
        <div>
          <h1 className="page-title">API Batch Process</h1>
...
export default ApiBatchProcess;
...
const [mstSave, set_mstSave]= useState(false)
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            {/* {msg&&<span>{msg}</span>} */}
                {/* <ApiTestCaseForm  mode={mode} setData={setData} data={data} rowData={rowData} onClose={onClose} index={index} queryInputObj={queryInputObj} 
