...
import { WebPortalMasterForm } from "./WPF00001_02";
...
const WebPortalMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/WPF00001/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "portalTitle",
                header: "Portal Title",
                size: 240,

            },
            {
                accessorKey: "portalDesc",
                header: "Portal description",
                size: 240,

            },
            {
                accessorKey: "portalLogoUrl",
                header: "Portal Logo Url",
                size: 240,

            },
            {
                accessorKey: "portalLogoMobUrl",
                header: "Portal Logo Mobile Url",
                size: 280,

            },
            {
                accessorKey: "portalLogoDarkUrl",
                header: "Portal Logo Dark Url",
                size: 240,

            },
            {
                accessorKey: "portalLogoMobDarkUrl",
                header: "Portal Logo Mobile Dark Url",
                size: 280,

            },
            {
                accessorKey: "portalFaviconUrl",
                header: "Portal Favicon Url",
                size: 240,
            ...
            {
                accessorKey: "portalPubIp",
                header: "Portal Public Ip",
                size: 240,

            },
            {
                accessorKey: "portalPvtIp",
                header: "Portal Private IP",
                size: 240,
    ...
    const handle_savePath = async () => {
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/WPF00001/saveAdd',
            body,
            { headers }
        ).then((res) => {
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Web Portal Master</h1>
          ...
          <i className="fa fa-star"></i> */}
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        {/* <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/WPF00001_03`}
                        >
                            <span>
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.portalTitle} name="portalTitle" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="portal Title" />
...
export default WebPortalMaster;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp, parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/WPF00001/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00001/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00001/openEditForm";
            body = {
                apiId: "WPA00004",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00001/openDeleteForm";
            body = {
                apiId: "WPA00003",
                mst: {
                    portalId: rowData.portalId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00001/openViewForm";
            body = {
                apiId: "WPA00006",
                mst: {
                    portalId: rowData.portalId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <WebPortalMasterForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
