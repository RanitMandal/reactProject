...
import { MenuTypeMasterAdd } from "./WPF00002_02";
...
const MenuTypeMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/WPF00002/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "menuTypTitle",
                header: "TITLE",
                size: 80,

            },
            {
                accessorKey: "menuTypDesc",
                header: "Description",
                size: 40,
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Menu Type Master</h1>
          ...
          <div className="col-md-6">
            <div className="input-group">
              <span className="input-group-text bg-primary" ><i className="fa fa-search d-inline text-white" title="" onClick={() => setShowModelPortalLov(true)} /></span>
              ...
              <input
                ...
                required
                value={queryInputObj?.criteria?.portalId}
                ...
                />}
                            ...
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj?.criteria?.menuTypTitle} name="menuTypTitle" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Enter Title Here" />
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00002/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00002/openEditForm";
            body = {
                apiId: "WPA00014",
                mst: {
                    "menuTypId": rowData?.menuTypId
                }
            }
        }
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00002/openDeleteForm";
            body = {
                apiId: "WPA00013",
                mst: {
                    "menuTypId": rowData?.menuTypId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/WPF00002/openViewForm";
            body = {
                apiId: "WPA00016",
                mst: {
                    "menuTypId": rowData?.menuTypId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <MenuTypeMasterAdd mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
