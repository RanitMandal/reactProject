                                    ...
                                    <form >
                                      <div className="tab-pane" id="tab21">
                                        ...
                                        {otpOptn?.genOpt && <>
                                          ...
                                          {otpOptn.otpMobFlg === "Y" && <div className="row mb-4">
                                            {/* <label className="col-md-3 form-label">Mobile OTP:</label> */}
                                            {/* style={errorMsg.VldtMsg ? { borderColor: "red" } : { borderColor: " #ecf0fa" }} */}
                                            <div className="wrap-input100 validate-input">
                                              <input className="form-control input100" name="validateMobOtp" maxLength={6} type="text" autoComplete="off" placeholder="Mobile OTP" value={formData.validateMobOtp} onChange={handleInputChange} disabled={changeBtn.mobOtp} />
                                              <span className="focus-input100"></span>
                                              <span className="symbol-input100">
                                        ...
                                        {caseState === 2 && <button className="login100-form-btn btn-primary"
                                          onClick={() => resendOTP("IU")} type="button"><ReplayIcon />&nbsp; Resend &nbsp; {minutes < 10 ? "0" + minutes : minutes}:{seconds < 10 ? "0" + seconds : seconds}
                                    ...
                                    <form onSubmit={handleSubmit}>
                                      <div className="tab-pane active show" id="tab20">
                                        ...
                                        <div className="text-end pt-1">
                                          <p className="mb-0">
                                            <Link
                                              to={`${process.env.PUBLIC_URL}/SUF00033_04/`}
                                              className="text-primary ms-1"
                                            >
                                              Forgot Password?
                                            </Link>
