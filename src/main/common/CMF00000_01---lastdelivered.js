...
export default function Login() {
    ...
    if (caseState === 1) {
      let otpChngLogObj =
      {
        ...
        mst: {
          ...
          otpTypCd: otpTypCd,
          refApiId: name === "IU" ? "SUA00636" : "SUA00635" //saveEdit
        }
      }
      setLoading({
        ...loading,
  ...
  const handleSubmit = async (e) => {
    ...
    const { emailId, mobNo, optnChngLogNo, emailOtp, mobileOtp, emailOtpLogNo, mobOtpLogNo, validateMobOtp, validateEmailOtp, ...obj } = formData
    let url = process.env.REACT_APP_API_URL_PREFIX + '/token/generate-token';
    await axios.post(url, obj/* , {headers} */)
      .then(response => {
        if (response.data.appMsgList.errorStatus === true) {
          set_errorMsgUserId(response.data?.appMsgList?.list[0]?.errDesc)
        }
        const data = (response.data.content.detailData.listLocation);
        if ((response.data.code === 0) || (response.data.code === 400)) {
  ...
  // changing tab clear all stored value...........
  ...
  return (
                ...
                <div className=" tab-menu-heading border">
                  <div className="tabs-menu1 tabstyle2">
                    <Tabs
                      ...
                      fill
                      onSelect={() => handleClear("EU")}
                    >
                      <Tab eventKey="tab6" className=" me-1" title="External User Login" onEntered={(e) => handleClear(e, "EU")}>

                        <Card.Body>
                          {/* <form className="login100-form validate-form" onSubmit={handleSubmit}> */}
                          <span className="login100-form-title">External User Login</span>
                            ...
                            <div className="tab-pane" id="tab21">
                              ...
                              {otpOptn?.genOpt && <>
                                {otpOptn.otpEmailFlg === "Y" && <div className="row mb-4">
                                  ...
                                  <div className="wrap-input100 validate-input">
                                    <input className="form-control input100" name="validateEmailOtp" autoComplete="off" type="text" value={formData.validateEmailOtp} maxLength={6} placeholder="Email OTP" onChange={handleInputChange} />
                                    <span className="focus-input100"></span>
                                    <span className="symbol-input100">
                                ...
                                {otpOptn.otpMobFlg === "Y" && <div className="row mb-4">
                                  ...
                                  <div className="wrap-input100 validate-input">
                                    <input className="form-control input100" name="validateMobOtp" type="text" autoComplete="off" placeholder="Mobile OTP" maxLength={6} value={formData.validateMobOtp} onChange={handleInputChange} />
                                    <span className="focus-input100"></span>
                                    <span className="symbol-input100">
                                      <i className="zmdi zmdi-key"></i>
                                    </span>
    ...
    <button type="submit" className='login100-form-btn btn-primary'>Login</button>
                      ...
                      <Tab eventKey="tab5" className=" me-1" title="Internal User Login"  >

                        <Card.Body>
                          {/* <form className="login100-form validate-form" onSubmit={handleSubmit}> */}
                          <span className="login100-form-title">Internal User Login</span>
                          ...
                          <div className="panel panel-primary">
                            <div className=" tab-menu-heading border">
                              <div className="tabs-menu1 tabstyle2">
                                <Tabs
                                  ...
                                  fill
                                  variant="underline"
                                  defaultActiveKey="tab21"
                                  className="panel-tabs mb-4"
                                // transition="false"


                                >
                                  {/* Mobile Login  */}
                                  <Tab eventKey="tab21" title="Mobile Login" onEntered={(e) => handleClear("IU")}>
                                    <form >
                                      <div className="tab-pane" id="tab21">
                                        {/* Mobile No */}
                                        <div className="wrap-input100 validate-input">
                                        ...
                                        {loading.otpOptn ? "Loading...." : otpOptn && otpOptn.userOptnSelFlg === "Y" && <div className="row mb-4 mt-0">
                                          ...
                                          {otpOptn.process && <div className="row mb-4 d-flex justify-content-center">
                                            <label className="Col-md-6 form-label">Choose Options to get OTP</label>
                                            <div className="form-check form-switch col-md-6 mt-1">
                                              <input disabled={otpOptn?.genOpt} className="form-check-input mx-1" type="checkbox" role="switch" name="otpEmailFlg" checked={otpOptn.otpEmailFlg === "Y"} onChange={(e) => handleFlgChng(e, "IU", "otpEmailFlg")} />
                                              <label className="form-check-label" style={{ marginLeft: "30%" }} >Email OTP</label>
                                            </div>
                                            <div className="form-check form-switch col-md-6 mt-1">
                                              <input disabled={otpOptn?.genOpt} className="form-check-input mx-1" type="checkbox" role="switch" name="otpMobFlg" checked={otpOptn.otpMobFlg === "Y"} onChange={(e) => handleFlgChng(e, "IU", "otpMobFlg")} />
                                              <label className="form-check-label" style={{ marginLeft: "30%" }} >Mobile OTP</label>
                                            </div>
                                          </div>}
                                        ...
                                        {otpOptn?.genOpt && <>
                                          {otpOptn.otpEmailFlg === "Y" && <div className="row mb-4">
                                            ...
                                            <div className="wrap-input100 validate-input">
                                              ...
                                              {changeBtn.vldtCheck ? (changeBtn.otpEmailFlg ? <span className="symbol-input1000"><i className="zmdi zmdi-check" style={{ color: "green" }}></i></span> : <span className="symbol-input1000"><i className="zmdi zmdi-close" style={{ color: "red" }}></i></span>) : ""}
                                          ...
                                          {otpOptn.otpMobFlg === "Y" && <div className="row mb-4">
                                            {/* <label className="col-md-3 form-label">Mobile OTP:</label> */}
                                            <div className="wrap-input100 validate-input">
                                              <input className="form-control input100" style={errorMsg.VldtMsg ? { borderColor: "red" } : { borderColor: " #ecf0fa" }} name="validateMobOtp" maxLength={6} type="text" autoComplete="off" placeholder="Mobile OTP" value={formData.validateMobOtp} onChange={handleInputChange} />
                                              <span className="focus-input100"></span>
                                              <span className="symbol-input100">
                                                <i class="zmdi zmdi-key"></i>
                                              </span>
                                        ...
                                        {evntMsg && <div className="text-red text-center mb-4">{dialogMsg()}</div>}
                                        {(resendOtpFlag) && <div className="text-center"><span className="text-red">OTP Expired within</span> {otpMinutes < 10 ? "0" + otpMinutes : otpMinutes}:{otpSeconds < 10 ? "0" + otpSeconds : otpSeconds}</div>}

                                        <div className="container-login100-form-btn mb-4">
                                          <button className="login100-form-btn btn-primary" type="button" disabled={caseState ? caseState === 2 ? otpOptn.vldbtn : false : false} onClick={(e) => handleSendOtp(e, "IU")}>{loading.genOtp ? "Loading....." : buttonTitle()}</button>
                                        </div>
                                        {caseState === 2 && <button className="login100-form-btn btn-primary"
                                          onClick={() => resendOTP("IU")} type="button"><ReplayIcon />&nbsp; Resend &nbsp; {minutes < 10 ? "0" + minutes : minutes}:{seconds < 10 ? "0" : seconds}
                            ...
                            <button type="submit" className='login100-form-btn btn-primary'>Login</button>
                                  ...
                                  {/* User Id Login */}
                                  <Tab eventKey="tab20" title="User Id" onEntered={() => handleClear("IU")}>
                                    <form onSubmit={handleSubmit}>
                                      <div className="tab-pane active show" id="tab20">
                                        ...
                                        {errorMsgUserId && <div className="text-red text-center">{errorMsgUserId}</div>}
                    ...
                    >
                      Login
                          ...
                          {/* <div className="text-center pt-3">
                            ...
                            Don't Have an Account?
                              <Link
                                to={`${process.env.PUBLIC_URL}/CMF00000/register/`}
                                className="text-primary ms-1"
                              >
                                Register Now
                              </Link>
