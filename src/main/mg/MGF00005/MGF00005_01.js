...
import { EditMemoInformationEdit } from "./MGF00005_02";
...
const EditMemoInformation = () => {
    ...
    useEffect(() => {
        const openFrom = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + "/MGF00005/openForm", obj, { headers })
                .then((res) => {
    ...
    const postQuery = async (e) => {
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/MGF00005/getListPageData', queryInputObj, { headers }).then((res) => {
        ...
        <>
            <div >
                <div className="page-header">
                    <div>
                        <h1 className="page-title"> Edit Memo Information</h1>
                        ...
                        <form id="myForm" onSubmit={postQuery} className="py-4 mx-2">
                            ...
                            <div className="row mb-3 container">
                                ...
                                <div className="col-md-2">
                                    <input className="form-control" type="Date" name="fromDt" onChange={handleInputChange} value={queryInputObj?.fromDt} required />
                                ...
                                <div className="col-md-2">
                                    <input className="form-control" type="Date" name="toDt" onChange={handleInputChange} value={queryInputObj?.toDt} required />
                                    {/* {!isValidRange && <p className="text-red">Invalid Year Range</p>} */}
                                </div>
                                <label
                                    for="exampleFormControlSelect1"
                                ...
                                <div className="col-md-2">
                                    <select className="form-select" name="memoTyp" value={queryInputObj?.memoTyp} onChange={handleInputChange} >
                                        {showPage?.criteria?.ddMemoTyp?.map(
...
export default EditMemoInformation;
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj }) => {
    ...
    useEffect(() => {
        ...
        let body = {}
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00005/openEditForm";
            body =
            {
                apiId: "MGA00050",
                mst: {
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <EditMemoInformationEdit mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
                    msg={msg} msg1={msg1} setMsg={setMsg} setMsg1={setMsg1} msgTyp={msgTyp} msgTyp1={msgTyp1} setMsgTyp={setMsgTyp} setMsgTyp1={setMsgTyp1} edtVal={edtVal} setEdtVal={setEdtVal} errExp={errExp} set_errExp={set_errExp} />
            </DialogContent>
