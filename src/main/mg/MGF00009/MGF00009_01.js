...
import { ImportantFileAddForm } from "./MGF00009_02";
...
const ImportantFile = () => {
    ...
    useEffect(() => {
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/MGF00009/openForm', obj, { headers }).then((res) => {
        ...
        <>
            <div>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Important File</h1>
                    ...
                    <div className="container-fluid mb-5">
                        <form id="myForm" className="py-4" onSubmit={postQuery} >
                            ...
                            <div className="row mb-4">
                                ...
                                >
                                    <b>From Date:</b><span className="text-red">*</span>
                                </label>
                                <div className="col-md-3">
                                    <input className="form-control" type="Date" name="fromDate" onChange={handleInputChange} value={queryInputObj?.criteria?.fromDate} required />
                                ...
                                <label
                                    ...
                                    className="col-md-2 col-form-label"
                                >
                                    <b>To Date:</b><span className="text-red">*</span>
                                </label>
                                <div className="col-md-3">
                                    <input className="form-control" type="Date" name="toDate" onChange={handleInputChange} value={queryInputObj?.criteria?.toDate} required />
                                    {/* {!isValidRange && <p className="text-red">Invalid Year Range</p>} */}
                                </div>
                            </div>
                            {/* Reference Number */}
                            <div className="row mb-4">
                                ...
                                <div className="col-md-8">
                                    <input value={queryInputObj.criteria.refNo} name="refNo" onChange={handleInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="" />
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-md-8">
                                    <input value={queryInputObj.criteria.refText} name="refText" onChange={handleInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="" />
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-md-8 mb-2">
                                    <input value={queryInputObj.criteria.fileSubj} name="fileSubj" onChange={handleInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="" />
...
export const CreateNewAccountModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, setQueryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00009/openAddForm"
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00009/openEditForm";
            body = {
                apiId: "MGA00024",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00009/openDeleteForm";
            body = {
                apiId: "MGA00023",
                mst: {
                    fileNo: rowData.fileNo
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00009/openViewForm";
            body = {
                apiId: "MGA00025",
                mst: {
                    fileNo: rowData.fileNo
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0">
                <ImportantFileAddForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
