...
import { CellMrForm } from "./MGF00006_02";
...
const CellMaster = () => {
    ...
    useEffect(() => {
        ...
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/MGF00006/openForm', obj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "cellAbvr",
                header: "Cell Abbreviation",
                size: 240,
        ...
        <>
            ...
            <div openData={openData}>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Cell Master</h1>
                    ...
                    <div className="ms-auto pageheader-btn">
                        ...
                        <Link
                            ...
                            to={`${process.env.PUBLIC_URL}/MGF00006_03`}
                        >
                            <span>
                        ...
                        <form onSubmit={postQuery} id="myForm" className="py-4">
                            <div className="row mb-2 mx-2 ">
                                ...
                                <div className="col-sm-4 mb-2">
                                    <input value={queryInputObj.criteria.cellDesc} name="cellDesc" onChange={handleQueryInputChange} className="form-control" type="text" id="exampleFormControlSelect1" placeholder="Cell Description" />
...
export const CreateModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, parMsg, setParMsg, parMsgTyp, setParMsgTyp ,parErrExp, set_parErrExp }) => {
    ...
    //     let url= "";
    //     if (mode===1){
    //         url = process.env.REACT_APP_API_URL_PREFIX +"/su/MGF00006/openAddForm";
    //     }
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00006/openAddForm";
        }
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00006/openEditForm";
            body = {
                apiId: "MGA00014",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00006/openDeleteForm";
            body = {
                apiId: "MGA00013",
                mst: {
                    cellId: rowData.cellId
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/MGF00006/openViewForm";
            body = {
                apiId: "MGA00016",
                mst: {
                    cellId: rowData.cellId
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0" >
                {/* {msg&&<span>{msg}</span>} */}
                <CellMrForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj}
