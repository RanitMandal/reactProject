...
import LocationwiseSanctionedPostDefinitionForm from "./HRF00002_02";
...
import { postLovListColumns, subDivLovColumns } from "./columns";
import FavLink from "../../common/FavLink";
import { getScplAdContext } from "../../common/common";
const headers = { Authorization: 'Bearer ' + getApiToken() };
const LocationwiseSanctionedPostDefinition = () => {
    ...
    useEffect(() => {
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/HRF00002/openform', obj, { headers }).then((res) => {
    ...
    useEffect(() => {
        ...
        const fetchSubDivLovData = async () => {
            ...
            await axios
                .post(process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/getAllSubDivision", obj, { headers })
                .then((res) => {
                    console.log(res.data);
    ...
    useEffect(() => {
        ...
        const fetchPostLovData = async () => {
            let obj = {
                ...
                criteria: {
                    ...
                    subDivCd: openData.lvlTypCd==="04"|| openData.lvlTypCd==="09"?getSubDivCd(selectRowSubDivLov): openData.subDivCd
                  }
            }
            await axios
                .post(process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/getPostDefnByLvlRefCd", obj, { headers })
                .then((res) => {
                    console.log(res.data);
       ...
       openData && fetchPostLovData();
    }, [openData, selectRowSubDivLov]);
...
useEffect(() => {
 ...
 setQueryInputObj({
    ...
    const postQuery = async (e) => {
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/HRF00002/getListPageData', queryInputObj, { headers }).then((res) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: "noSancPost",
                header: "No. of Sanctioned Post",
                size: 240,
                muiTableBodyCellEditTextFieldProps: ({ cell }) => ({
                    ...getCommonEditTextFieldProps(cell),
                }),
        ...
        <>
            <div>
                <div className="page-header">
                    <div>
                        <h1 className="page-title">Location wise Sanctioned Post Definition</h1>
...
export default LocationwiseSanctionedPostDefinition;
...
export const CreateNewAccountModal = ({ open, columns, onClose, onSubmit, mode, rowId, setData, data, rowData, index, queryInputObj, lvlRefCd }) => {
    ...
    useEffect(() => {
        ...
        if (mode === 1) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/openAddForm";
            body = {
                apiId: "HRA00004",
                mst: {
                    lvlRefCd: lvlRefCd,
        ...
        if (mode === 2) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/openEditForm";
            body = {
                apiId: "HRA00011",
                mst: {
        ...
        if (mode === 3) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/openDeleteForm";
            body = {
                apiId: "HRA00010",
                mst: {
                    lvlRefCd: rowData.lvlRefCd,
        ...
        if (mode === 4) {
            url = process.env.REACT_APP_API_URL_PREFIX + "/HRF00002/openViewForm";
            body = {
                apiId: "HRA00012",
                mst: {
                    lvlRefCd: rowData.lvlRefCd,
    ...
    return (
        ...
        <Dialog open={open} setData={setData} data={data} fullWidth
            ...
            <DialogContent className="pb-0">
                <LocationwiseSanctionedPostDefinitionForm mode={mode} setData={setData} data={data} rowData={rowData} index={index} queryInputObj={queryInputObj} 
