...
const PostDesignationMapping = () => {
    ...
    useEffect(() => {
        const fetchOpenData = async () => {
            ...
            await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/HRF00012/openForm', obj, { headers }).then((res) => {
    ...
    useEffect(() => {
        ...
        const fetchRoleLovData = async () => {
            ...
            await axios
                .post(process.env.REACT_APP_API_URL_PREFIX + "/HRF00012/getAllPost", obj, { headers })
                .then((res) => {
                    console.log(res.data);
    ...
    const postQuery = async (e) => {
        ...
        await axios.post(process.env.REACT_APP_API_URL_PREFIX + '/HRF00012/getListPageData', queryInputObj, { headers }).then((res) => {
    ...
    const saveMap = async (selectedItems) => {
        ...
        try {
            ...
            const requestBody = selectedItems.map((item) => ({
                ...
                postCd: getPostCd(selectRowRoleLov),
                dsgnCd: item.dsgnCd
            ...
            const response = await axios.post(
                process.env.REACT_APP_API_URL_PREFIX + '/HRF00012/saveMap',
                updatedMapObj,
                { headers }
            );
    ...
    const saveUnMap = async (selectedItems) => {
        ...
        try {
            ...
            // Send a POST request to the API
            const response = await axios.post(
                process.env.REACT_APP_API_URL_PREFIX + '/HRF00012/saveUnMap',
                updatedUnMapObj,
                { headers }
            );
    ...
    const handleSelectItem = (item, direction) => {
        const updatedItems =
            direction === "left"
                ? leftItems.map((i) =>
                    i.dsgnCd === item.dsgnCd ? { ...i, selected: !i.selected } : i
                )
                : rightItems.map((i) =>
                    i.dsgnCd === item.dsgnCd ? { ...i, selected: !i.selected } : i
                );
        ...
        <>
            ...
            <div>
                <div className="page-header">
                    <div>
                        <h1 className="page-title"> Post Designation Mapping</h1>
                                ...
                                <div className="col-md-6">
                                    <div className="input-group">
                                        ...
                                        <input
                                            ...
                                            required
                                            value={getPostCd(selectRowRoleLov) ? getPostCd(selectRowRoleLov) : ''}
                                        />
                                        <input
                                            type="text"
                                            autoComplete={false}
                                            ...
                                            required
                                            value={getPostNm(selectRowRoleLov) ? getPostNm(selectRowRoleLov) : ''}
                                        />
                                        ...
                                        <List  >
                                            <Box sx={{
                                                ...
                                                {leftItems.map((item) => (
                                                    ...
                                                    <ListItem key={item.dsgnCd} disablePadding>
                                                        <Checkbox
                                                        ...
                                                        />
                                                        <ListItemText primary={item.dsgnNm} />
                                                    </ListItem>
...
export default PostDesignationMapping;