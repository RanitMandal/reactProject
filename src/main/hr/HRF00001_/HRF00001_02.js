            ...
            <form className="form-horizontal container" id="EditPageForm" onSubmit={(e) => handleSubmit(e, mode, data, setData, onClose)}>
              ...
              {fieldCharCountVisibility.currPin && (
                  ...
                  {formData?.currPin?.length}/6
                    ...
                    <div className="col-md-2">
                        <select
                            ...
                            //defaultValue={edtVal.dtlActFlg}
                            onChange={handleSelectChange}
                            value={queryInputObj.permAddrFlg}
                ...
                <div className="row mb-4">
                    ...
                    <div className="col-md-9 input-group">
                        <TextArea className="form-control" type="text" value={formData.permAddr} name="permAddr" onChange={handleInputChange} disabled={mode === 3 || mode === 4} maxLength={200} onFocus={() => toggleCharCountVisibility("permAddr")}
              ...
              {fieldCharCountVisibility.permAddr && (
                ...
                <div className="row mb-4">
                    ...
                    <div className="col-md-3 input-group">
                        <input className="form-control" type="text" value={formData.permPin} name="permPin" onChange={handleInputChange} disabled={mode === 3 || mode === 4} maxLength={6} onFocus={() => toggleCharCountVisibility("permPin")}
                ...
                <span className="input-group-text">
                  {formData?.permPin?.length}/6
                    ...
                    <div className="col-md-3">
                        ...
                        maxLength={6} onFocus={() => toggleCharCountVisibility("mobNo")}
