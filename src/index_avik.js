...
const ChangeRequest = React.lazy(() =>
  import("./main/su/SUF00137/SUF00137_03")
);
...
const ExternalUserRegistrationMaster = React.lazy(() => import("./main/su/SUF00150/SUF00150_01"));
...
<Route
               ...
               <Route
                  path={`${process.env.PUBLIC_URL}/SUF00137_03`}
...
<Route
            ...
            >
              ...
              />
              <Route
                path={`${process.env.PUBLIC_URL}/SUF00150/SUF00150_03/external_user_register`}
