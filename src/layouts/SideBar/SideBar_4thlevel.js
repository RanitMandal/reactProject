                              ...
                              <li key={index}>
                                ...
                                {childrenItem.children.length ? (
                                    ...
                                    {childrenItem.children.map(
                                      (childrenSubItem, key) => (
                                        <li key={key}>
                                          ...
                                          {childrenSubItem.children.length ? (
                                            <ul
                                              className="sub-slide-menu"
                                              style={
                                                childrenItem.active
                                            ...
                                            >
                                              {childrenSubItem.children.map(
                                                  (children_4thlvl, key) => (
                                                    <li key={key}>
                                                      {children_4thlvl.type === "sub" ? (
                                  <a
                                    href="javascript"
                                    className="sub-side-menu__item"
                                    onClick={(event) => {
                                      event.preventDefault();
                                      toggletNavActive(children_4thlvl);
                                    }}
                                  >
                                    <span className="sub-side-menu__label">
                                      {children_4thlvl.title}
                                    </span>
                                    {children_4thlvl.active ? (
                                      <i className="sub-angle  fa fa-angle-down"></i>
                                    ) : (
                                      <i className="sub-angle fa fa-angle-right"></i>
                                    )}
                                  ...
                                  ""
                                          ...
                                          {children_4thlvl.type === "link" ? (
                                            <NavLink
                                              to={children_4thlvl.path + ""}
                                              className={`${"sub-slide-item"}`}
                                              onClick={() =>
                                                toggletNavActive(
                                                  children_4thlvl
