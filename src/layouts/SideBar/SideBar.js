...
const Sidebar = ({sidebarModId}) => {
  ...
  useEffect(() => {
      ...
      await axios.post(process.env.REACT_APP_API_URL_PREFIX +`/token/menuTree`, body,  {headers} )
          .then(response => {
            ...
            if(sidebarModId) {
              ...
              // console.log("2222222222222",response.data?.content?.menuItems[0].items);
              findList({children: response.data?.content?.menuItems[0].items})
              sessionStorage.setItem("sidebarlinkList", JSON.stringify([...dataList]))
              console.log("33333333333333",dataList);
...
// }
  ...
  useEffect(() => {
    ...
    const currentUrl = urlArr[urlArr.length-1].slice(0, -1);
    console.log(Url,urlArr, currentUrl);
                                          ...
                                          {childrenSubItem.type === "link" ? (
                                            <NavLink
                                              ...
                                              onClick={() =>
                                                ...
                                                sessionStorage.setItem("currentPath",  JSON.stringify(childrenSubItem));
                                              }
                                              }
                                            >
